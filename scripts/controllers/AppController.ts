        ...
        */
        ...
        private executeLines(inputRecords: any,itemIndex: number)   {
           ...
           // this.scope.loadingData = true;
            ...
            this.appService.getPDS001Sync(inputRecords[nextItem].W1FACI, inputRecords[nextItem].W1ITNO,"100").then((val: M3.IMIResponse) => {
...
/**
   ...
   private executeAsynchronuslyInBatch(program: string, transaction: string, maxNumberOfRecords: number, inputRecords: any): ng.IPromise<any> {
    ...
    inputRecords.forEach((record) => {
        ...
        record.errorCode = "";
        record.apiResponse = "";
    let promise1 = this.appService.getPDS001(record.CONO,record.DIVI,record.W1FACI, record.W1ITNO,record.W1PCDT, "100", record.W1PCTP,record.W1RORN,record.W1VASE,record.WWCSU1,record.WWMAUM).then((val: any) => {
